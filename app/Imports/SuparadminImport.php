...
class SuparadminImport implements ToCollection, WithHeadingRow
{
    /**
    * @param Collection $collection
    */

    protected $suparadmin_id;

    public function __construct($suparadmin_id)
    {
        $this->suparadmin_id = $suparadmin_id;
    }
    ...
    public function collection(Collection $rows)
    {
         foreach ($rows as $row) 
        {
            ...
            {
                $lead->update([
           'suparadmin_id' => $this->suparadmin_id,
